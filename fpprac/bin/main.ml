...
let _ =
  Js.export_all
    (object%js
       method get_ao_trace s n = get_lambda__small_step AO s n
       method get_no_trace s n = get_lambda__small_step NO s n
       method get_cbn_trace s n = get_lambda__small_step CBN s n
       method get_cbv_trace s n = get_lambda__small_step CBV s n
    end)
